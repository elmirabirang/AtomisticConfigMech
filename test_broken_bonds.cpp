...
//    boundaries.push_back(boundary_right);
//    boundaries.push_back(boundary_left);
...
// 		ufile << atoms.size() << endl;
    ...
    string path2="/calculate/elmira/Implementations/PyQC_C++/pyQC _C++ version/tests/results/dim2/material/blunting/large_displacement_step/configurational_force/broken_bonds/dump.cracktip";
    ofstream ffile;
	ffile.open(path2.c_str());

    string path3="/calculate/elmira/Implementations/PyQC_C++/pyQC _C++ version/tests/results/dim2/material/blunting/large_displacement_step/configurational_force/broken_bonds/dump.totalenergy";
    ofstream Efile;
	Efile.open(path3.c_str());

    string path4="/calculate/elmira/Implementations/PyQC_C++/pyQC _C++ version/tests/results/dim2/material/blunting/large_displacement_step/configurational_force/broken_bonds/dump.reactionforce";
    ofstream EFfile;
	EFfile.open(path4.c_str());

    string path5="/calculate/elmira/Implementations/PyQC_C++/pyQC _C++ version/tests/results/dim2/material/blunting/large_displacement_step/configurational_force/broken_bonds/dump.neighbors";
    ofstream Nfile;
...
//    	options.max_line_search_step_expansion=2;
    ...
    if( load_step > 29 && load_step <41 )
    {
    	if (check_broken_bond==false)
    	{
    	ceres::GradientProblem problem (new MolecularStatic(atoms, 1.0, 1.0, num_optimized_atoms));
    	ceres::GradientProblemSolver::Options options;
    	options.minimizer_progress_to_stdout=true;
    ...
    if (load_step>41 && load_step<83)
    {
    	...
    	ceres::Solve(options, problem, parameters, &summary);
    	std::cout << summary.FullReport()<< "\n";
    	check_broken_bond=false;

    }

    if(load_step > 82 && load_step < 125)
    {
    	if (check_broken_bond==false)
    	{
    	ceres::GradientProblem problem (new MolecularStatic(atoms, 1.0, 1.0, num_optimized_atoms));
...
/////////////////////////////////////////////////////////////OutPut Texts Files//////////////////////////////////////////////////////////////////////////////////////////////
    ...
    string path="/calculate/elmira/Implementations/PyQC_C++/pyQC _C++ version/tests/results/dim2/material/blunting/large_displacement_step/configurational_force/broken_bonds/dump.crack";
    string path1="/calculate/elmira/Implementations/PyQC_C++/pyQC _C++ version/tests/results/dim2/spatial/blunting/large_displacement_step/configurational_force/broken_bonds/dump.crackspatial" ;
    string path5="/calculate/elmira/Implementations/PyQC_C++/pyQC _C++ version/tests/results/dim2/material/blunting/large_displacement_step/configurational_force/broken_bonds/dump.temporalmaterial";
...
//		Mfile << atoms.size() << endl;
	...
	writeDataFile <2> (atoms, load_step, write_data_path);
...
//		{
//
//			check_broken_bond=ConfigForceCriterion <2> (atoms);
//
//		}
	...
	else if ( load_step > 41 && load_step < 83  )
	{
	...
	else if ( load_step > 82 && load_step < 125 )
