...
template <int dim>
double ModifiedTersoff <dim>::ModiTers(Atom <dim> &atom_Alpha, Atom <dim> &atom_beta, Atom <dim> &atom_Gamma){
    ...
    double spatial_distance_ij = bond.SpatialBondDistance(atomi,atomj);
    double spatial_distance_ik = bond.SpatialBondDistance(atomi,atomk);

    Point <dim> spatial_vector_ij = bond.SpatialBondVec(atomi,atomj);
    ...
    Point <dim> spatial_vector_ik = bond.SpatialBondVec(atomi,atomk);
