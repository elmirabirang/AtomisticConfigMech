...
template <int dim>
vector < Atom <dim>* > CrackAtom <dim>::getCrackBottomAtoms()
{
...
template <int dim>
void CrackAtom <dim>::setCrackBottomAtoms(vector < Atom <dim>* > bottom_atoms)
{
...
template <int dim>
vector <Atom <dim>* > CrackAtom <dim>::getCrackTopAtoms()
{
